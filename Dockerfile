...
LABEL maintainer="McDull" \
    ...
    org.opencontainers.image.description="Docker image used to run an IPsec VPN server, with both IPsec/L2TP and Cisco IPsec." \
    org.opencontainers.image.url="https://github.com/mcdull-github/docker-l2tp" \
    org.opencontainers.image.source="https://github.com/mcdull-github/docker-l2tp" \
    org.opencontainers.image.documentation="https://github.com/mcdull-github/docker-l2tp"
